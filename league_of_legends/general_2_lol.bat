...
start "zapret" /min "%~dp0..\bin\winws.exe" --wf-tcp=80,443,2099 --wf-udp=443,50000-50100 ^
...
--filter-tcp=443 --hostlist-exclude="%~dp0..\lists\list-exclude.txt" --ipset="%~dp0..\lists\list-ipset.txt" --hostlist="%~dp0..\lists\list.txt" --hostlist="%~dp0..\lists\list-additional.txt" --hostlist-auto="%~dp0..\lists\autohostlist.txt" --hostlist-auto-fail-time=3 --hostlist-auto-fail-threshold=1 --dpi-desync=split2 --dpi-desync-split-seqovl=652 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl-pattern="%~dp0..\fake\tls_google.bin" --new ^
